...
<body>
	...
	<div class="container" style="justify-content:space-around;">
		...
		<div class="flexitem" >
			A ∩ B = <input type="text" name="set2" id="box3" readonly>
		</div>
	</div>
	<b style="position: absolute;top:210px;left:510px">A</b>
		<b style="position: absolute;top:210px;left:700px">B</b>
				<b style="position: absolute;top:270px;left:590px;z-index: 99;">A ∩ B</b>
...
<script type="text/javascript">
	...
	document.getElementById("box3").value=a_inter_b;
