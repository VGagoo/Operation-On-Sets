	...
	<body>
		...
		<div class="mainarea">
			<div class="container" style="justify-content:space-around;">
				<div class="flexitem" >
					A = <input type="text" name="set1" id="box1" placeholder="Separate elements by space">
				</div>
				<div class="flexitem">
					B = <input type="text" name="set2" id="box2" placeholder="Separate elements by space">
					<br>
				</div>
				<div class="flexitem" >
					A U B = <input type="text" name="set2" id="box3" readonly>
				</div>
			</div>
			...
			<div class="c1" id="c1" style="color:#009FA1;text-shadow: 1px 1px 4px #c1ff09;"></div>
			<div class="c2" id="c2" style="color:#009FA1;text-shadow: 4px 4px 4px #c1ff09;"></div>
			<div class="i" id="i" style="color:#009FA1;text-shadow: 4px 4px 4px #c1ff09;"></div>
			<input type="button" class="button" onclick="find()" name="compute" style="height: 45px;margin:15px" value="Compute Result">
			<p>In the venn diagram A, B<br>
			and the intersected area is A U B</p>
		</div>
		</form>
	</body>
	<script type="text/javascript">

		//regex /^(?<big>[a-zA-Z0-9]+)(,(?&big))*$/gm
	function find()
	{
		var a_inter_b=[];
		var the_a=[];
	...
	result=the_a.concat(a_inter_b.concat(the_b));
